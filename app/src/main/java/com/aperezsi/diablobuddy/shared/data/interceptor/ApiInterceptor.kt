...
class ApiInterceptor @Inject constructor(private val sessionPreferences: SessionPreferences): Interceptor {
    ...
    private fun addAccessTokenIfMissing(request: Request): Request {
        ...
        if (currentUrl.queryParameter("access_token") == null) {
            ...
            newUrl.addQueryParameter("access_token", sessionPreferences.getAccessToken())
